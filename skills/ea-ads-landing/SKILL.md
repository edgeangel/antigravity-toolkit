...
- **Google Ads** : `ea-ads-google` — le Quality Score intègre la landing page experience
- **Meta Ads** : `ea-ads-meta` — Meta pénalise la diffusion sur pages lentes
- **Références** : `ea-ads/references/benchmarks.md` et `ea-ads/references/conversion-tracking.md`

## Process

1. Collecter les URLs de landing pages des campagnes actives
2. Charger `ea-ads/references/benchmarks.md` pour les benchmarks CVR
3. Charger `ea-ads/references/conversion-tracking.md` pour la vérification pixel/tags
4. Évaluer chaque page sur les critères ci-dessous
5. Générer les recommandations priorisées par impact conversion
